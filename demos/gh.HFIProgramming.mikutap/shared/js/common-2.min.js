				...
				if (
					...
					_isJapanese ||
						(null != document.getElementById("google_translate_element") &&
							$.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function () {
										...
										("none" == $(".skiptranslate").css("display")
											...
											: (e &&
													("block" == $("#menu_sp").css("display")
														...
														: $("#menu").css("top", 39)),
												480 > $(window).width()
													? $("iframe:first").contents().find(".goog-te-button").css("display", "none")
													: $("iframe:first").contents().find(".goog-te-button").css("display", "block"),
												0 != t.tw && $("#goog-gt-tt").css({ display: "none", opacity: 0 })));
								}, 100);
...
(aidn.init = {
	...
	selectBasePath: function (e, t) {
		...
		return (
			(isNaN(n) || 1 == t) && ((n = Math.floor(Math.random() * e.length)), aidn.util.setCookie("baseid", n, 604800)),
			(e.length <= n || 0 > n) && (n = 0),
			(this.basepath = e[n])
		);
	},
	...
	(aidn.ref = {
		init: function (e) {
			0 < this.__total &&
				e != this.__interval &&
				(clearInterval(this.__sid), (this.__sid = setInterval(this.__update, e))),
				(this.__interval = e);
		},
		...
		removeInterval: function (e) {
			for (var t = 0; t < this.__total; t++)
				this.__list[t].func == e && (delete this.__list[t], this.__list.splice(t, 1), this.__total--);
			0 == this.__total && clearInterval(this.__sid);
		},
		__update: function () {
			for (var e, t = aidn.ref.__list, n = aidn.ref.__total, i = aidn.ref.__interval, o = 0; o < n; o++)
				(e = t[o]), (e.time += i), e.delay < e.time && ((e.time -= e.delay), e.func());
		},
		__interval: 10,
		__sid: -1,
		__list: [],
	...
	(aidn.util = {
		...
		checkJapanese: function () {
			return (
				...
				!!(
					"ja" == this.getLanguage() ||
					(this.lowerAndroid(2.4) && 0 < navigator.userAgent.toLowerCase().indexOf("ja-jp"))
				)
			);
		},
		...
		fullscreen: function (e) {
			aidn.util.checkFullscreen()
				...
				: (e ? "string" == typeof e && (e = document.getElementById(e)) : (e = document.body),
		...
		needExpandArea: function (e) {
			var t = navigator.userAgent,
				n = 0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod");
			return (
				(n = n && 0 <= t.indexOf("Version/") && 600 > Math.max(window.screen.width, window.screen.height)) &&
					1 == e &&
	...
	(aidn.social = {
		...
		shareTw: function (e, t, n, i, o) {
			0 <= e.indexOf("https://aidn.jp") && (e = e.replace("https", "http")),
				...
				t && !aidn.util.checkMobile()
					? window.open(e, "tw", "width=730, height=460, personalbar=0,toolbar=0,scrollbars=1,resizable=1")
					: (location.href = e);
		},
		shareFb: function (e, t) {
			...
			t
				? aidn.util.checkMobile()
					? window.open(n)
					: window.open(n, "fb", "width=730, height=460, personalbar=0,toolbar=0,scrollbars=1,resizable=1")
				: (location.href = n);
		},
		shareGp: function (e, t) {
			...
			t
				? aidn.util.checkMobile()
					? window.open(n)
					: window.open(n, "gp", "width=960, height=790, personalbar=0,toolbar=0,scrollbars=1,resizable=1")
				: (location.href = n);
		},
...
(_active = "undefined" == typeof swfobject || (swfobject.hasFlashPlayerVersion("9") && !aidn.util.checkMobile())) ||
	...
	(aidn.AutoAudio = function (e, t, n) {
		...
		var i = 2;
		"undefined" != typeof swfobject && swfobject.hasFlashPlayerVersion(10) && null != e
			? (i = 0)
		...
		if (
			...
			var d = setInterval(function () {
				document.getElementById("flash_audio").loadFunc &&
					(clearInterval(d), (o = document.getElementById("flash_audio")), t(i));
			}, 100);
		} else

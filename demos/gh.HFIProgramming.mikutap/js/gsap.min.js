...
!(function (t, e) {
	...
	function Ba(t, e) {
		...
		if (
			((e._time || (e._initted && !e._dur)) &&
				((r = ya(t.rawTime(), e)), (!e._dur || yt(0, e.totalDuration(), r) - e._tTime > j) && e.render(r, !0)),
	...
	function Ea(t, e, r, i) {
		return (
			Nt(t, e),
			t._initted
				? !r && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && f !== Pt.frame
	...
	function Xa(u, t) {
		...
		return (
			!e &&
				s(u) &&
				((h = e = u.radius || U), u.values ? ((u = Tt(u.values)), (l = !q(u[0])) && (h *= h)) : (u = Wa(u.increment))),
			Ma(
				t,
				e
					? p(u)
						...
						: function (t) {
								for (
									var e, r, i = parseFloat(l ? t.x : t), n = parseFloat(l ? t.y : 0), a = U, s = 0, o = u.length;
									o--;
		...
		for (var r, i = t._first; i; )
			(i instanceof Bt
				...
				: !i.vars.yoyoEase ||
					(i._yoyo && i._repeat) ||
					i._yoyo === e ||
					(i.timeline ? Eb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
				(i = i._next));
	}
	function Gb(t, e, r, i) {
		(void 0 === r &&
	...
	function zk(t) {
		...
		if (
			(k < a && (A += a - C),
			(0 < (e = (i = (D += a) - A) - z) || s) &&
				((n = ++b.frame), (T = i - 1e3 * b.time), (b.time = i /= 1e3), (z += e + (S <= e ? 4 : S - e)), (r = 1)),
			s || (m = g(zk)),
			r)
		)
	...
	var Lt,
		...
		Ft =
			...
			(Lt.time = function time(t, e) {
				return arguments.length
					? this.totalTime(Math.min(this.totalDuration(), t + wa(this)) % this._dur || (t ? this._dur : 0), e)
					: this._time;
			}),
							...
							((this._ps = t)
								...
								: (At(),
									...
									this.totalTime(
										...
										1 === this.progress() && (this._tTime -= j) && Math.abs(this._zTime) !== j,
									))),
						this)
					: this._ps;
			}),
			...
			(Lt.reversed = function reversed(t) {
				return arguments.length
					? (!!t !== this.reversed() && this.timeScale(-this._rts || (t ? -j : 0)), this)
					: this._rts < 0;
			}),
			...
			(Lt.isActive = function isActive() {
				var t,
					...
					r = this._start;
				return !(
					e && !(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - j)
				);
			}),
					...
					if (
						...
						if (
							...
							if (
								((g = this._dur),
								(m = this._tDur),
								T && ((this._lock = 2), (_ = b ? g : -1e-4), this.render(_, !0)),
								(this._lock = 0),
								!this._ts && !u)
							)
								return this;
			...
			(e.totalTime = function totalTime(t, e) {
				return arguments.length
					? ((this._forcing = 1),
						!this._dp &&
							this._ts &&
							(this._start = ca(Pt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
		...
		Yt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
			...
			if (
				(o(i) &&
					...
					"=" === i.charAt(1) &&
						(i = parseFloat(d) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (Oa(d) || 0))),
				d !== i)
			)
				return isNaN(d * i)
					? (f || e in t || N(e, i),
					...
					: ((l = new ie(this._pt, t, e, +d || 0, i - (d || 0), "boolean" == typeof f ? $t : Ht, 0, c)),
						h && (l.fp = h),
					...
					if (
						...
						for (a in i)
							ft[a] && (f = Qb(a, i, e, c, o, I))
								? f.priority && (u = 1)
								: (d[a] = s = Yt.call(e, o, a, "get", i[a], c, I, 0, g.stringFilter));
		...
		Vt = (function (A) {
			function Tween(e, r, i, n) {
				...
				if (
					...
					if (
						((r = a.vars),
						(o = a.timeline = new Bt({ data: "nested", defaults: x || {} })).kill(),
				...
				return (
					!0 !== T || R || ((qt = _assertThisInitialized(a)), F.killTweensOf(P), (qt = 0)),
			...
			return (
						...
						!(function _renderZeroDurationTween(t, e, r, i) {
							...
							if (
								...
								(t._startAt && e < 0 && t._startAt.render(e, !0, !0),
									...
									(e >= t._tDur || e < 0) &&
										t.ratio === u &&
										(u && sa(t, 1), r || (xt(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom())));
				...
				(e.kill = function kill(t, e) {
					...
					if (this.timeline) {
						...
						return (
							this.timeline.killTweensOf(t, e, qt && !0 !== qt.vars.overwrite)._first || ib(this),
							this.parent &&
	...
	(ba(
		...
		(F = new Bt({ sortChildren: !1, defaults: B, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
		(Y.stringFilter = tb));
	var ne = {
	...
	function sd(e) {
		...
		return (
			...
			!r || r.width || r.x || r.y
				? r
				: { x: +rd(e, ["x", "cx", "x1"]) || 0, y: +rd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 }
		);
	}
	function td(t) {
	...
	function yd(t, e, r, i) {
		...
		return (
			...
			Se[e] && "transform" !== e
				? ((n = Je(t, i)), (n = "transformOrigin" !== e ? n[e] : We(md(t, Ye)) + " " + n.zOrigin + "px"))
				: ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) ||
					(n = (Ve[e] && Ve[e](t, e, r)) || md(t, e) || aa(t, e) || ("opacity" === e ? 1 : 0)),
	...
	function Vd(t, e, r) {
		...
		for (n in (l.svg
			...
			: ((a = getComputedStyle(r)[qe]), (f[qe] = e), (i = Je(r, 1)), (f[qe] = a)),
		Se))
			(a = l[n]) !== (s = i[n]) &&
	...
	var se,
		...
		tr = function _renderCSSTransforms(t, e) {
			...
			(_ !== Ze && (y += "perspective(" + _ + Ke),
				(i || n) && (y += "translate(" + i + "%, " + n + "%) "),
				(!b && a === Ze && s === Ze && o === Ze) ||
					(y += o !== Ze || b ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + Ke),
				u !== $e && (y += "rotate(" + u + Ke),
				h !== $e && (y += "rotateY(" + h + Ke),
				l !== $e && (y += "rotateX(" + l + Ke),
					...
					if ("autoRound" !== f && ((s = e[f]), !ft[f] || !Qb(f, e, r, i, t, n)))
						if (
							...
							if (
								...
								f in Be &&
									("autoAlpha" === f &&
										(1 === u && "hidden" === yd(t, "visibility") && o && (u = 0),
								...
								if (
									(m ||
										(((g = t._gsap).renderTransform && !e.parseTransform) || Je(t, e.parseTransform),
									...
									if ("transformOrigin" === f) {
										((s = Bd(s)),
											g.svg
												? Jd(t, s, 0, v, 0, this)
												: ((c = parseFloat(s.split(" ")[2]) || 0) !== g.zOrigin && vd(this, g, "zOrigin", g.zOrigin, c),
							...
							if (_ || ((o || 0 === o) && (u || 0 === u) && !Fe.test(s) && f in T))
								((o = o || 0),
									(d = (a + "").substr((u + "").length)) !== (c = Oa(s) || (f in Y.units ? Y.units[f] : d)) &&
										(u = xd(t, f, a, c)),
									(this._pt = new ie(
										this._pt,
										_ ? g : T,
										...
										u,
										p ? p * o : o - u,
										_ || ("px" !== c && "zIndex" !== f) || !1 === e.autoRound ? Yc : _c,
									)),
									(this._pt.u = c || 0),

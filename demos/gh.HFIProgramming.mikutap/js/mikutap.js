...
var MainManager = function () {
		...
		var m,
			...
			g = new (function () {
						...
						var f = function (n) {
							...
							function o() {
								0 == u
									? ((u = 1),
										(s = { x: r.x, y: r.y }),
										gsap.to(s, f, { x: l.x, y: l.y, ease: Power1.easeOut, onUpdate: i, onComplete: o }))
									: (v.clear(), (v.visible = !1));
							}
							this.play = function (n, a, e, t) {
								return (
									...
									(s = { x: r.x, y: r.y }),
									gsap.to(s, c, { x: l.x, y: l.y, ease: Power1.easeOut, onUpdate: i, onComplete: o }),
									c + f
								);
							};
							var r,
					...
					m = [
							...
							var s = function (n) {
								...
								this.play = function (n, a, e) {
									...
									return (
										...
										gsap.to(s.scale, r, { x: 1, y: 1, ease: Back.easeOut.config(1.7) }),
										r
									);
								};
								var a = n,
									...
									(this.play = function (n, a) {
										(i = a),
											...
											gsap.fromTo(
												...
												0.3,
												{ x: 0, y: 0 },
												{ x: 1, y: 1, ease: Back.easeOut.config(1.7), onComplete: t, delay: n },
											),
											gsap.fromTo(
												l,
												0.7,
							...
							this.play = function () {
								!(function () {
									...
									l.clear(),
										...
										(l.scale.x = 0),
										(s.scale.y = 0),
										(n = Math.random() < 0.5 ? (-135 * Math.PI) / 180 : (215 * Math.PI) / 180),
										new TimelineLite()
						...
						function (n, a) {
							function o() {
								...
								else gsap.to(f, 0.1, { x: h[c].x, y: h[c].y, onComplete: o, onUpdate: e, ease: Power1.easeOut });
							}
							function e() {
				...
				var T,
					P = [
						13430510, 8965324, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015,
						3222317,
					],
					k = [
						13430510, 8965324, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015,

...
- 1. 在 `package.json` 的 `bin` 中显式增加语义化短名入口 `claude-notifier`，与 `@ruan-cat/claude-notifier` 共同指向同一 CLI，使 npm / pnpm / yarn 全局安装后均可稳定使用短命令。 ([`fa34524`](https://github.com/ruan-cat/monorepo/commit/fa34524d4e8898d603d26a69d2c9344645eacd90))
...
- ## 🔧 修复 Stop Hooks stdin 竞争问题，优化任务管理架构 ([`f9c7290`](https://github.com/ruan-cat/monorepo/commit/f9c729086ef2212086df89dc90adea67c1c71917))
...
- 修复 Stop hooks 超时和逻辑错误，优化性能，确保任务正确清理 ([`62939d2`](https://github.com/ruan-cat/monorepo/commit/62939d281cc412ba593a255357f26748f91e7b57))

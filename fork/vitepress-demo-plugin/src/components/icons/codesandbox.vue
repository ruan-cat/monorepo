<template>
	<form action="https://codesandbox.io/api/v1/sandboxes/define" method="post" target="_blank" style="display: flex">
		...
		<input style="display: none" name="query" :value="`module=${initialFile}`" />
		<button type="submit">
			<svg
...
import { ComponentType, DEFAULT_DESCRIPTION, DEFAULT_TITLE, PlatformTemplate } from "@/constant/type";
